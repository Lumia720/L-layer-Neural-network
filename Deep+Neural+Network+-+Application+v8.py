...
n_h = 7 #number of units in the hidden layers
...
def two_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):
    ...
    W2 = parameters["W2"]
    b2 = parameters["b2"]
    print(type(linear_forward(X, W1, b1)))
...
def L_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 4500, print_cost=False):#lr was 0.009
    """
...
## START CODE HERE ##
my_image = "mydog3.jpg" # change this to the name of your image file 
